...
router.get('/user-list', function(req, res, next) {
    ...
    if (err) throw err;
    res.render('admin/user-list', { title: 'User List', userData: data});
  });
});
//send email
function sendEmail(email, token) {
  ...
  service: 'gmail',
  auth: {
  user: 'madhugumangu@gmail.com', // Your email id
  pass: '13@Dh21KeaRe@12' // Your password
  }
  });
  var mailOptions = {
  from: 'madhugumangu@gmail.com',
  to: email,
  subject: 'Reset Password Link - FunOlympic.com',
